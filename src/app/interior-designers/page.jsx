  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-[64px] lg:py-[80px]">
        <div className="w-full max-w-[815px] mx-auto flex flex-col items-center gap-[32px] h-auto lg:h-[213px] text-center">
          <h1 className="font-switzer font-medium text-[32px] sm:text-[42px] lg:text-[54px] leading-[100%] tracking-[0%] text-black w-full max-w-[815px] h-auto lg:h-[71px] mx-auto text-center">
            Bring Your Space to Life
          </h1>

          <p className="font-switzer font-normal text-[16px] sm:text-[18px] leading-[27px] tracking-[0%] text-black w-full max-w-[577px] mx-auto">
            Work with top-rated interior designers who turn ideas into stunning,
            livable designs.
          </p>

          <button className="bg-[#186AFF] text-white font-switzer font-medium text-[18px] leading-[100%] px-[20px] py-[10px] rounded-[6px] hover:bg-[#155DE0] transition">
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[32px]">
            {architects.map((architect) => (
              ...
              >
                {/* Header */}
                <div className="p-[24px] border-b border-gray-100 bg-[#E9F5D6]">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-start space-x-3">
                      <div className="w-12 h-12 rounded-full relative">
                        ...
                        <Image
                          src="https://res.cloudinary.com/dzpezyxt2/image/upload/v1764827183/70b9487dc81a4a27708ab6ca7d329302ce8b22ac_zxdm5j.png"
                          alt="Verified"
                          width={100}
                          height={100}
                      ...
                      <div>
                        <h3 className="font-switzer font-medium text-[22px] leading-[100%] text-black">
                          {architect.name}
                        </h3>
                        <p className="font-switzer font-medium pt-1 text-[14px] leading-[100%] text-[#00000099]">
                          {architect.location}
                        </p>
                      </div>
                    </div>
