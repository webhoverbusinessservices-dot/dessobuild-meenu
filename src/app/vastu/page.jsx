    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-[64px] lg:py-[80px]">
        <div className=" w-full max-w-[815px] mx-auto flex flex-col items-center gap-[32px] h-auto lg:h-[213px] text-center ">
          ...
          {/* ---------- PARAGRAPH ---------- */}
          <p
            className=" font-switzer font-normal text-[16px] sm:text-[18px] leading-[27px] tracking-[0%] text-black
    text-center w-full max-w-[665px] mx-auto"
          >
            {" "}
            Balance your home and workspace with professionals who bring
            harmony, energy, and positive flow through authentic Vastu
            principles.
          </p>

          {/* ---------- BUTTON ---------- */}
          <button
            className="bg-[#186AFF] text-white font-switzer font-medium text-[18px] leading-[100%] px-[20px] py-[10px]                        
        rounded-[6px] hover:bg-[#155DE0] transition"
          >
            {" "}
            Hire Vastu Experts
          </button>
            ...
            <div className="max-w-[1200px] mx-auto">
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[32px]">
                  {architects.map((architect) => (
                     ...
                     >
                        {/* Header */}
                        <div className="p-[24px] border-b border-gray-100 bg-[#F5F4D6]">
